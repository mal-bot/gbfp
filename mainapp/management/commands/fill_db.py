...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        responses = [
            ...
            {'user': User.objects.filter(username='test5').first(),
             'resume': Resume.objects.filter(id=25).first()},
            {'user': User.objects.filter(username='test4').first(),
             'resume': Resume.objects.filter(id=25).first()},
            {'user': User.objects.filter(username='test5').first(),
             'resume': Resume.objects.filter(id=24).first()},
            {'user': User.objects.filter(username='test4').first(),
             'resume': Resume.objects.filter(id=24).first()},
            {'user': User.objects.filter(username='test5').first(),
             'resume': Resume.objects.filter(id=23).first()},
            {'user': User.objects.filter(username='test4').first(),
             'resume': Resume.objects.filter(id=23).first()},
            {'user': User.objects.filter(username='test5').first(),
             'resume': Resume.objects.filter(id=22).first()},
            {'user': User.objects.filter(username='test4').first(),
             'resume': Resume.objects.filter(id=22).first()},
            {'user': User.objects.filter(username='test5').first(),
             'resume': Resume.objects.filter(id=7).first()},
            ...
            {'user': User.objects.filter(username='test3').first(),
             'vacancy': Vacancy.objects.filter(id=22).first()},
            {'user': User.objects.filter(username='test2').first(),
             'vacancy': Vacancy.objects.filter(id=23).first()},
            {'user': User.objects.filter(username='test2').first(),
             'vacancy': Vacancy.objects.filter(id=24).first()},
            {'user': User.objects.filter(username='test3').first(),
             'vacancy': Vacancy.objects.filter(id=25).first()},
            {'user': User.objects.filter(username='test2').first(),
             'vacancy': Vacancy.objects.filter(id=26).first()},
            {'user': User.objects.filter(username='test2').first(),
             'vacancy': Vacancy.objects.filter(id=25).first()},
            {'user': User.objects.filter(username='test3').first(),
             'vacancy': Vacancy.objects.filter(id=7).first()},
